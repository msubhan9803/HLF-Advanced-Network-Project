...
export PEER0_ORG2_CA=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
export MAX_RETRY=5
export CLI_DELAY=3
...
export ORDERER_CA=${PWD}/channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
export ORDERER_ADMIN_TLS_SIGN_CERT=${PWD}/channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/tls/server.crt
export ORDERER_ADMIN_TLS_PRIVATE_KEY=${PWD}/channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/tls/server.key
...
generateCryptoMaterial() {
    ...
    ./bin/cryptogen generate --config=./crypto-config.yaml --output="./channel-artifacts"
}
...
joinChannelAsPeer1Org1() {
    export PEER1_ORG1_CA=${PWD}/channel-artifacts/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls/ca.crt
...
joinChannelAsPeer0Org2() {
    ...
    export CORE_PEER_MSPCONFIGPATH=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
    export PEER0_ORG2_CA=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
...
joinChannelAsPeer1Org2() {
    export PEER1_ORG2_CA=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/ca.crt
...
packageChaincode() {
    ...
    export FABRIC_CFG_PATH=$PWD/
    peer lifecycle chaincode package fabcar_1.0.tar.gz --path ./chaincode/ --lang golang --label fabcar_1.0
}

installChaincodeOnPeer0Org1() {
    export CORE_PEER_TLS_ENABLED=true
    export CORE_PEER_LOCALMSPID="Org1MSP"
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/channel-artifacts/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt
    export CORE_PEER_MSPCONFIGPATH=${PWD}/channel-artifacts/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
    export CORE_PEER_ADDRESS=localhost:7051
...
installChaincodeOnPeer1Org1() {
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/channel-artifacts/peerOrganizations/org1.example.com/peers/peer1.org1.example.com/tls/ca.crt
    export CORE_PEER_MSPCONFIGPATH=${PWD}/channel-artifacts/peerOrganizations/org1.example.com/users/Admin@org1.example.com/msp
    export CORE_PEER_ADDRESS=localhost:8051
    peer lifecycle chaincode install fabcar_1.0.tar.gz
...
installChaincodeOnPeer0Org2() {
    export CORE_PEER_TLS_ENABLED=true
    export CORE_PEER_LOCALMSPID="Org2MSP"
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
    export CORE_PEER_MSPCONFIGPATH=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
    export CORE_PEER_ADDRESS=localhost:9051
...
installChaincodeOnPeer1Org2() {
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/peers/peer1.org2.example.com/tls/ca.crt
    export CORE_PEER_MSPCONFIGPATH=${PWD}/channel-artifacts/peerOrganizations/org2.example.com/users/Admin@org2.example.com/msp
    export CORE_PEER_ADDRESS=localhost:10051
...
approveChaincodeForOrg2() {
    ...
    peer lifecycle chaincode approveformyorg -o localhost:7050 \
        ...
        --cafile ${PWD}/channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
...
checkCommitReadiness() {
    ...
    peer lifecycle chaincode checkcommitreadiness --channelID mychannel \
        ...
        --cafile ${PWD}/channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem --output json
}
...
commitChaincode() {
    ...
    peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com \
        ...
        --cafile ${PWD}/channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem \
        --peerAddresses localhost:7051 --tlsRootCertFiles ${PWD}/channel-artifacts/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt \
        --peerAddresses localhost:9051 --tlsRootCertFiles ${PWD}/channel-artifacts/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt
}
...
invodeChaincode() {
    ...
    peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls \
        --cafile ${PWD}/channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem \
        -C mychannel -n basic --peerAddresses localhost:7051 --tlsRootCertFiles ${PWD}/channel-artifacts/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt \
        --peerAddresses localhost:9051 --tlsRootCertFiles ${PWD}/channel-artifacts/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt \
...
createCar() {
    ...
    peer chaincode invoke -C mychannel -n basic -c '{"Args":["createCar", "CAR10", "Pak", "My-Car", "Black", "Subhan"]}' \
        ...
        --tlsRootCertFiles channel-artifacts/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt \
        --tlsRootCertFiles channel-artifacts/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt --tls \
        --cafile channel-artifacts/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
}
